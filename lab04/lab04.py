...
def distance(city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    dis=math.sqrt(((get_lat(city1)-get_lat(city2))**2)+((get_lon(city1)-get_lon(city2))**2))
    return dis
...
def closer_city(lat, lon, city1, city2):
    ...
    """
    "*** YOUR CODE HERE ***"
    citytest=make_city('test',lat,lon)
    dis1=distance(city1,citytest)
    dis2=distance(city2,citytest)
    if dis1>dis2:
